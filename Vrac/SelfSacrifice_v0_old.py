...
class Scenario(ED.Default_Scenario):
	...
	def deathProbability(self, indiv):
		" Probability that an individual will self-sacrifice during a given year"
	...
	def selfSacrifice(self, indiv):
		...
		bool = p > random() & indiv.age > ((percent(self.Parameter('SacrificeMaturity')) * self.Parameter('AgeMax'))))
