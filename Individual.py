...
from Evolife.Ecology.Alliances import Follower as AsymetricalSocialLink	#modif
...
class EvolifeIndividual(Individual, Genome, Phenome, AsymetricalSocialLink):	#modif
...
#MOFIFs
		...
		AsymetricalSocialLink.__init__(self, self.Scenario.Parameter('MaxGurus', Default=0), self.Scenario.Parameter('MaxFollowers',Default=10))
		self.descendants = []			#TRICHE
		self.selfSacrifice = False		#Triche2
